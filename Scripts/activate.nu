...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\PC\.virtualenvs\HotelImperial-9v-XtINn'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('HotelImperial' == '') {
...
alias deactivate = source 'C:\Users\PC\.virtualenvs\HotelImperial-9v-XtINn\Scripts\deactivate.nu'
